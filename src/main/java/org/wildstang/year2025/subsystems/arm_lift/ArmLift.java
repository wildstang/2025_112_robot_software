...
public class ArmLift implements Subsystem {
    ...
    private void competitionControlSystem(){
        ...
        //  if (newState != gameState || isFront != newFront) {
